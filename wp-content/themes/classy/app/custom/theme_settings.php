...
function al_theme_setup()
{
    if (function_exists('acf_add_options_page')) {
        ...
        acf_add_options_page(array(
            'page_title' => __('Theme Settings', preg_replace('/^www\./','',$server_name)),
            //'menu_title' => __('Theme Settings', preg_replace('/^www\./','',$server_name)),
	    ...
	    acf_add_options_page(array(
		    'page_title' => __('Services', preg_replace('/^www\./','',$server_name)),
		    'menu_title' => __('Services', preg_replace('/^www\./','',$server_name)),
		    //'parent_slug' => 'theme-general-settings',
	    ));

//        acf_add_options_sub_page(array(
//            'page_title' => __('Header', preg_replace('/^www\./','',$server_name)),
//            'menu_title' => __('Header', preg_replace('/^www\./','',$server_name)),
//            'parent_slug' => 'theme-general-settings',
//        ));
